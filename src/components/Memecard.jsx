...
export default function MemeCard({ meme }) {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow overflow-hidden border border-gray-250 dark:border-zinc-700 hover:shadow-lg transition-all duration-200 w-170 mx-auto my-4">
